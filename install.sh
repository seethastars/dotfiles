...
do
  ...
  if [[ $resp == "Y" ]] || [[ $resp == "y" ]]; then
    ...
    sudo pacman -S hyprland qt5-wayland qt6-wayland xdg-desktop-portal-hyprland xdg-desktop-portal-gtk polkit-kde-agent waybar wofi kitty hyprpaper hyprlock nwg-look thunar thunar-archive-plugin xarchiver gvfs-afc gvfs-gphoto2 imagemagick pavucontrol brightnessctl wl-clipboard ristretto unzip unrar p7zip grim slurp gamemode alsa-utils cmus papirus-icon-theme gnome-themes-extra ttf-jetbrains-mono-nerd adobe-source-han-sans-jp-fonts

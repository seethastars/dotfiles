...
do
  ...
  if [[ $resp == "Y" ]] || [[ $resp == "y" ]]; then
    ...
    sudo pacman -S hyprpaper waybar nwg-look thunar thunar-archive-plugin xarchiver gvfs-afc gvfs-gphoto2 imagemagick pavucontrol brightnessctl wl-clipboard ristretto unzip unrar grim slurp gamemode alsa-utils vlc ttf-jetbrains-mono-nerd papirus-icon-theme adobe-source-han-sans-jp-fonts
